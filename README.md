...
- `PUT https://snappychatapi.herokuapp.com/api/chats`
	...
	#####Request
		PUT https://snappychatapi.herokuapp.com/api/chats?user_sender_id=grinch@gmail.com&user_receiver_id=grinch3@gmail.com
	#####Response
